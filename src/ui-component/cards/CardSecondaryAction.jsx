...
export default function CardSecondaryAction({ title, link, icon }) {
  ...
  return (
    <Tooltip title={title || 'Référence'} placement="left">
      <ButtonBase disableRipple>
        {!icon && (
          <Avatar component={Link} href={link} aria-label="redirection vers les pages" target="_blank" alt="Logo MUI" size="badge" outline>
